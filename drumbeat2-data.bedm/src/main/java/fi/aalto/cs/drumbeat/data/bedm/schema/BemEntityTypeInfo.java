...
public class BemEntityTypeInfo extends BemNonCollectionTypeInfo {
	...
	public BemAttributeInfo getAttributeInfo(String name) throws DrbNotFoundException {
		return getAttributeInfo(name, false);
	}

	public BemAttributeInfo getAttributeInfo(String name, boolean includeInverseLinks) throws DrbNotFoundException {
