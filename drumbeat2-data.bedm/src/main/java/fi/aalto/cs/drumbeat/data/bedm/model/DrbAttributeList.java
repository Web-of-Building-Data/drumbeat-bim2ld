...
public class DrbAttributeList<T extends DrbAttribute> extends SortedList<T> {
	...
	/**
	 * Selects attribute by a specified {@link DrbAttributeInfo} and {@link DrbValue}.
	 * @param attributeInfo
	 * @param value
	 * @return
	 */
	public T select(DrbAttributeInfo attributeInfo, DrbValue value) {
	...
	/**
	 * Selects attributes by a specified {@link DrbAttributeInfo}.
	 * @param attributeInfo
	 * @return
	 */
	public T selectFirst(DrbAttributeInfo attributeInfo) {
	 ...
	 * @return
	 */
	public List<T> selectAll(DrbAttributeInfo attributeInfo) {
...
//		}		
	 ...
	 * @return
	 */
	public T remove(DrbAttributeInfo attributeInfo, DrbValue value) {
	...
	public Map<DrbAttributeInfo, DrbAttributeList<T>> toMap() {
		Map<DrbAttributeInfo, DrbAttributeList<T>> map = new TreeMap<>();
		for (T t : this) {
			DrbAttributeInfo attributeInfo = t.getAttributeInfo();
			DrbAttributeList<T> list = map.get(attributeInfo);
			if (list == null) {
				list = new DrbAttributeList<>();
