...
public class BemSchema {
	...
	private Map<String, BemTypeInfo> nonEntityTypeInfoDictionary;
	private Map<String, BemEntityTypeInfo> entityTypeInfoDictionary;
	
	
	public BemSchema() {
		allTypeInfoDictionary = new HashMap<>();
		nonEntityTypeInfoDictionary = new HashMap<>();
	...
	public Collection<BemTypeInfo> getNonEntityTypeInfos() {
	 ...
	 */
	public BemTypeInfo getTypeInfo(String typeName) throws DrbNotFoundException {
	 ...
	 * @throws DrbNotFoundException
	 */
	public BemEntityTypeInfo getEntityTypeInfo(String typeName) throws DrbNotFoundException {
		String upperTypeName = typeName.toUpperCase();
	 ...
	 * @throws DrbNotFoundException
	 */
	public BemTypeInfo getNonEntityTypeInfo(String typeName) throws DrbNotFoundException {
		String upperCaseTypeName = typeName.toUpperCase();
		BemTypeInfo result = nonEntityTypeInfoDictionary.get(upperCaseTypeName);
		if (result == null) {
	...
	public void addNonEntityTypeInfo(BemTypeInfo typeInfo) {
	...
	public void addEntityTypeInfo(BemEntityTypeInfo typeInfo) {
		String upperCaseTypeName = typeInfo.getName().toUpperCase();
		allTypeInfoDictionary.put(upperCaseTypeName, typeInfo);
