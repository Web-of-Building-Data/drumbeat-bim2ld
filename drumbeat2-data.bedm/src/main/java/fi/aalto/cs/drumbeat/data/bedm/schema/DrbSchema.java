...
public class DrbSchema {
	...
	private String name;
	private DrbSchema header;
	private Map<String, DrbTypeInfo> allTypeInfoDictionary;
	private Map<String, DrbTypeInfo> nonEntityTypeInfoDictionary;
	private Map<String, DrbEntityTypeInfo> entityTypeInfoDictionary;
	 ...
	 * @return
	 */
	public DrbSchema getHeader() {
		return header;
	}
	
	public void setHeader(DrbSchema header) {
		this.header = header;
	}
