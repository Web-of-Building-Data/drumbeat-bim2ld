...
//		ifcSchema = new BemSchema(TEST_SCHEMA_VERSION);
//	}
//
//	@Test
...
//				Bem2RdfConversionContextParams.VALUE_XSD_DOUBLE);
//		
//		Bem2RdfConverter converter = new Bem2RdfConverter(context, ifcSchema);
...
//		context.getConversionParams().setParamValue(
//				Bem2RdfConversionContextParams.PARAM_CONVERT_DOUBLES_TO,
//				Bem2RdfConversionContextParams.VALUE_XSD_DECIMAL);
//		
//		Bem2RdfConverter converter = new Bem2RdfConverter(context, ifcSchema);
//		Resource xsdDataType = converter.getBaseTypeForLiterals(ifcSchema.REAL);
...
////		context.getConversionParams().setParamValue(
////				Bem2RdfConversionContextParams.PARAM_CONVERT_DOUBLES_TO,
////				Bem2RdfConversionContextParams.VALUE_AUTO_MOST_EFFICIENT);
...
////		
////		Bem2RdfSchemaExporter converter = new Bem2RdfSchemaExporter(ifcSchema, context, jenaModel);
////		Resource xsdDataType = converter.getBaseTypeForLiterals(ifcSchema.REAL);
////		assertEquals(XSD.xdouble, xsdDataType);
////	}	
////
...
////		context.getConversionParams().setParamValue(
////				Bem2RdfConversionContextParams.PARAM_CONVERT_DOUBLES_TO,
////				Bem2RdfConversionContextParams.VALUE_AUTO_MOST_SUPPORTED);
////		OwlProfileList owlProfiles = new OwlProfileList();
////		owlProfiles.add(new OwlProfile(OwlProfileEnum.OWL2_RL));
////		context.setOwlProfiles(owlProfiles);
////		
...
//		
//		BemLiteralValue value = new BemLiteralValue(d, ifcSchema.REAL, BemTypeEnum.REAL);
...
//		
//		Statement valueStatement = node.asResource().getProperty(Bem2RdfVocabulary.EXPRESS.hasReal);
