 ...
 *
 */
public abstract class DrbTypeInfo implements Comparable<DrbTypeInfo> {
	
	private final DrbSchema schema;
	 ...
	 * 
	 */
	public DrbTypeInfo(DrbSchema schema, String name) {
		this.schema = schema;
		this.name = name;
	}
	...
	@Override
	public int compareTo(DrbTypeInfo o) {
